...
public final class LineageSettings {
    ...
    public static final class System extends Settings.NameValueTable {
         ...
         * (See KEY_THREE_FINGERS_LONG_PRESS_ACTION for valid values)
         */
        public static final String KEY_THREE_FINGERS_LONG_SWIPE_ACTION = "key_three_fingers_long_swipe_action";

        /** @hide */
        public static final Validator KEY_THREE_FINGERS_LONG_SWIPE_ACTION_VALIDATOR =
                new InclusiveIntegerRangeValidator(0, 17);
        ...
        static {
            ...
            VALIDATORS.put(KEY_THREE_FINGERS_LONG_SWIPE_ACTION, KEY_THREE_FINGERS_LONG_SWIPE_ACTION_VALIDATOR);
